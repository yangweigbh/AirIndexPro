package com.yangwei.airindexpro.quadtree;
...
public class QuadTree {
    ...
    public Point findNearestPoint(double x, double y) {
    	return findNearestPointUtil(root_, x, y).getPoint();
	}
    
    private Node findNearestPointUtil(Node parent, double x, double y) {
    	Node resposne = null;
        switch (parent.getNodeType()) {
            ...
            case POINTER:
                resposne = this.findNearestPointUtil(this.getQuadrantForPoint(parent, x, y), x, y);
                break;
