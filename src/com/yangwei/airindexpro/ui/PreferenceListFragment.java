...
public class PreferenceListFragment extends ListFragment{
    ...
    public static PreferenceListFragment newInstance(int xmlID) {
    	PreferenceListFragment f = new PreferenceListFragment();

        // Supply xmlID input as an argument.
        Bundle args = new Bundle();
        args.putInt("xml", xmlID);
        f.setArguments(args);
